...
import SchoolLogo from '../../assets/School-Img-Logo.jpeg'
        ...
        <div className="bg-gray-600 text-gray-50 h-20 
         flex items-center justify-between">
            ...
            flex items-center justify-center"> */}
                {/* LOGO */}
                <img className="p-2 h-20 w-15 rounded-full 
                    flex items-center justify-center" src={SchoolLogo} alt="SchoolLogo" />
        {/* </div> */}
